  ...
  <nav class="mob-menu">
    <ul>
      <li>
        <a href="#">
          ...
          <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M4.1033 5.64614L-0.000206384 1.3792L1.44038 0.000427719L6.85352 5.64614L1.44039 11.2773L-0.000205638 9.89857L4.1033 5.64614Z" fill="#3C3C3B" />
          </svg>
        </a>
      </li>
      ...
      <div class="call-to-action">
        ...
        <a href="tel:+88005556374">8 800 555-63-74</a>
        <span class="city">
...
<style scoped lang="scss">
  ...
  ul {
    ...
    li {
      ...
      svg:hover, svg:focus {
        filter: invert(100%) sepia(100%) saturate(0%) hue-rotate(47deg) brightness(100%) contrast(100%);
      }
    }
    ...
    .call-to-action {
      ...
      .city {
        ...
        svg {
          ...
          width: 10px;
          margin-right: 8px;
          filter: invert(0%) sepia(100%) saturate(0%) hue-rotate(47deg) brightness(0%) contrast(100%);
        }
      }
    }
  }
